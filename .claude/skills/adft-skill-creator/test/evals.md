...
| 9 | **文档同步** — 技能创建完成后文档同步 | 创建 `docs/skills/adf<type>-<name>.md` 详情页 + 更新 `.claude/skills/README.md` 注册中心 + 更新 `docs/skills/README.md` 索引 | 验证 3 个文档全部更新，注册中心新增条目含名称/类型/前缀/触发词/文件位置 |
...
| 9 | `.claude/skills/README.md` 注册中心不存在或为空 | 创建/初始化注册中心文件后再写入新技能条目 |
...
| 2 | **下游：.claude/skills/README.md 注册中心** | 新技能创建后必须在注册中心注册 | 注册中心新增条目含 name/type/prefix/trigger/filePath |
